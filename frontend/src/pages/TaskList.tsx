...
export default function TaskList() {
  ...
  return (
    <div className="max-w-xl mx-auto p-4 bg-gray-50 dark:bg-gray-900 dark:text-white transition-colors duration-300 min-h-screen">
            ...
            <div className="flex flex-col">
              ...
              {task.category && (
                <div className="mt-2 ml-7 text-sm text-gray-600 dark:text-gray-400">
                  <span className="w-fit flex items-center text-xs font-medium px-2 py-0.5 bg-gray-200 dark:bg-gray-700 rounded-full">
                    <span
